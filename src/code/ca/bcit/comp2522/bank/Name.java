...
public class Name
{
    ...
    private static final String BANNED_NAME = "xyz";

    static final int FIRST_CHARACTER = 0;
    static final int SECOND_CHARACTER = 1;
    ...
    public String getInitials()
    {
        ...
        firstInitial = first.substring(FIRST_CHARACTER, SECOND_CHARACTER).toUpperCase();
        lastInitial = last.substring(FIRST_CHARACTER, SECOND_CHARACTER).toUpperCase();
    ...
    public String getFullName()
    {
        ...
        firstNameFirstLetter = first.substring(FIRST_CHARACTER, SECOND_CHARACTER).toUpperCase();
        lastNameFirstLetter = last.substring(FIRST_CHARACTER, SECOND_CHARACTER).toUpperCase();

        restOfFirstName = first.substring(SECOND_CHARACTER).toLowerCase();
        restOfLastName = last.substring(SECOND_CHARACTER).toLowerCase();
